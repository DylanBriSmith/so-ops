...
def summarize_with_llm(
    ...
    prompt_lines = [
        ...
        "   If two findings share an IP, mention that inline in the relevant bullet instead of",
        "   a separate section.",
        "2. End with a one-line overall risk level: LOW / MEDIUM / HIGH / CRITICAL.",
        "",
        "Be concise and actionable. Focus on what needs to happen RIGHT NOW.",
        "Do not add a summary of the remaining/lower-priority findings — just the top",
        "findings and the risk level.",
        "Do not use markdown headers (##). Plain text and **bold** labels only.",
        "",
        "--- FINDINGS ---",
        "",
    ]
